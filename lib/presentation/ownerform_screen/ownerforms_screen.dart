...
class OwnerFornsScreen extends StatelessWidget {
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              CustomAppBar(
                title: MyText(title: "Owners Application Form",clr: ColorConstant.whiteA700,fontSize: 20,customWeight: FontWeight.w500,),
                centerTitle: true,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: getVerticalSize(10),),
                        CustomExpansionTile(
                          title: MyText(title:'Owner Application',clr: ColorConstant.black900,fontSize: 16,),
                          children:  <Widget>[
                            Column(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: CustomTextField(
                                        fieldText: "Allotment Letter held".tr,
                                        controller: controller.allotmentAddController,
                                        isFinal: false,
                                        keyboardType: TextInputType.emailAddress,
                                        limit: HelperFunction.EMAIL_VALIDATION,
                                        validator: (value) {
                                    ...
                                    Expanded(
                                      child: CustomTextField(
                                        fieldText: "Completion Certificate held".tr,
                                        controller: controller.completionAddController,
                                        isFinal: false,
                                        keyboardType: TextInputType.emailAddress,
                                        validator: (value) {
                                          return HelperFunction.empthyFieldValidator(value!);
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: CustomButton(
                                    ...
                                    label: "Attach Allotment Letter".tr,
                                ...
                                Padding(
                                  ...
                                  child: CustomButton(
                                    ...
                                    fontWeight: FontWeight.w700,
                                    color: ColorConstant.whiteA700,
                                    label: "Attach Approval of Building Plan".tr,
                                    textColor: ColorConstant.anbtnBlue,
                                    borderColor: ColorConstant.anbtnBlue,
                                    prefix: Icon(Icons.add_circle_outline,color: ColorConstant.anbtnBlue,),
                                    onPressed: () {
